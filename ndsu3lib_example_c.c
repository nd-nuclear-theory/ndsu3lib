/***************************************************************
 ...
 ndsu3lib_example_c.c -- simple program tabulating SU(3) reduced Wigner
...
// <(6,1)epsilon1,Lambda1;(2,1)epsilon2,Lambda2||(5,2)-9,5/2>_rho
{
  ...
  if (info != 0)
  {
    printf("calculate_wigner_canonical: invalid values of epsilon3 and Lambda3\n");
    return;
  }
  printf("SU(3)-SU(2)xU(1) reduced Wigner coefficients <(6,1)epsilon1,Lambda1;(2,1)epsilon2,Lambda2||(5,2)-9,5/2>_rho:\n");
...
// <(6,1)kappa1,2;(2,1)kappa2,3||(5,2)kappa3,3>_rho
{
  ...
  printf("\n");
  printf("SU(3)-SO(3) reduced Wigner coefficients <(6,1)kappa1,2;(2,1)kappa2,3||(5,2)kappa3,3>_rho:\n");
...
// U[(9,3)(1,1)(6,6)(2,2);(9,3)rhoa,rhob(3,3)rhoc,rhod]
{
  ...
  if(info != 0)
  {
    printf("calculate_u_coeff: MKL subroutine dgesv ran with error: info=%d\n", info);
    return;
  }
...
// Z[(9,3)(1,1)(6,6)(2,2);(9,3)rhoa,rhob(3,3)rhoc,rhod]
{
  ...
  if(info != 0)
  {
    printf("calculate_z_coeff: MKL subroutine dgesv ran with error: info=%d\n", info);
    return;
  }
...
//                                      |rho13 rho24 rho1234       |
{
  ...
  if(info != 0)
  {
    printf("calculate_9_lambda_mu: MKL subroutine dgesv ran with error: info=%d\n", info);
    return;
  }
