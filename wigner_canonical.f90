...
! for given lambda1,mu1,lambda2,mu2,lambda3,mu3,epsilon3,Lambda3 using Eq.(19) in [1] and Table 9.1 on page 311 in [2].
!
...
INTEGER :: eps3,rho,p1,q1,p2,q2,Lam32,epsilon2max,epsilon3min,Lambda22,Lambda12,Lam32prime,p3,q3,&
           q2min,p1min,pq1,noname1,noname2,Rp2,Sq2,s2,lm1,lm2,lm3,mu1p2,mu2p2,mu3p2
REAL(KIND=8) :: N3
...
! 3) ABS(Lambda12-Lambda22)<=Lam32<=Lambda12+Lambda22, where Lambda12=mu1+p1-q1
        ...
        IF(Lam32>Lam32prime)THEN
          ...
          IF(p1/=lambda1)wigner(p1,p2,q2,1:rhomax)=wigner(p1,p2,q2,1:rhomax)+DSQRT(DFLOAT((p1+1)*(lambda1-p1)*(mu1p2+p1)&
