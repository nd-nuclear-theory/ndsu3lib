!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! wigner_canonical_extremal.f90 -- extremal SU(3)-SU(2)xU(1) reduced Wigner coefficients
!
! Jakub Herko
...
DO rho=1,rhomax
  ...
  END IF
  !***********************************************************************************************************
  ! Calculation of <(lambda1,mu1)epsilon1,Lambda1;(\bar{lambda2},\bar{mu2})HW||(lambda3,mu3)HW>_rho
  ! from <(lambda1,mu1)HW;(\bar{lambda2},\bar{mu2})epsilon2,Lambda2||(lambda3,mu3)HW>_rho using Eq.(21) in [1]
  !***********************************************************************************************************
  ...
  END IF
  !*******************************************************************************************************
  ! Calculation of <(lambda1,mu1)epsilon1,Lambda1;(lambda2,mu2)epsilon2,Lambda2||(lambda3,mu3)HW>_rho from
  ! <(lambda1,mu1)epsilon1,Lambda1;(lambda2,mu2)HW||(lambda3,mu3)HW>_rho using Eq.(18) in [1]
  !*******************************************************************************************************
  noname1=lambda2+mu2
