...
PROGRAM ndsu3lib_example
  ...
  IMPLICIT NONE
  TYPE(su3irrep) :: irrep1,irrep2,irrep3,irrep,irrep12,irrep23,irrep13,irrep4,irrep24,irrep34
  INTEGER :: epsilon3,Lambda3_twice,dimpq,dimw,rhomax,numb,i,p1,q1,p2,q2,epsilon1,Lambda1_twice,epsilon2,Lambda2_twice,&
       rho,L1,L2,L3,kappa1max,kappa2max,kappa3max,kappa1,kappa2,kappa3,rhomaxa,rhomaxb,rhomaxc,rhomaxd,&
       info,rhoa,rhob,rhoc,rhod,n,rhomax12,rhomax34,rhomax1234,rhomax13,rhomax24,rhomax1324,rho12,rho34,&
       rho1234,rho13,rho24,rho1324
  ...
  CALL calculate_wigner_canonical(irrep1,irrep2,irrep3,epsilon3,Lambda3_twice,dimpq,dimw,rhomax,numb,wigner_block,p1a,p2a,q2a)
